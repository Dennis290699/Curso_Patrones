...
public class PrincipalOpenGl {
	...
	private static Graficos graficos; // Assuming Graficos manages FiguraGeometrica objects

	public static void run() {
		System.out.println("Graficas" + Version.getVersion() + "!");
...
//			}
	...
	private static void loop() {
		...
		while (!glfwWindowShouldClose(window)) {
			...
			// Draw all shapes managed by graficos
			graficos.draw();
